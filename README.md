...
2. Continue to the [Demian Lab case studies](https://github.com/Aeshma-Daeva/Demian-Lab/blob/main/docs/CASE_STUDIES.md) for applied EEG, acoustic, well-log Geo, and Zenith research boundaries.
3. Use [NullFrame](https://github.com/Aeshma-Daeva/NullFrame#readme) as the map between concepts, source, experiments, and controls.
